...
try {
    ...
    console.log(`all parameters: gitRepo: ${gitRepo}, repoName: ${repoName}
    , imageName: ${imageName}, containerName: ${containerName}, containerPort: ${containerPort}, environment: ${environment}`)
